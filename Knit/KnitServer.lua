...
--[[
	I still create remote events but they essentially act like identifier passers (the name of the remote event is the identifier for the bridges from server-client)
	Also creating remote events makes any legacy (awful) knit code functional
]]
